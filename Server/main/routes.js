...
router.post('/api/posts/posts/poststodb', (req, res, next) => {
...
router.post('/api/post/commenttodb', (req, res, next) => {
    ...
    pool.query(`INSERT INTO posts(comment, user_id, author, post_id, date_created)
                VALUES($1, $2, $3, $4, NOW())`, values, (q_err, q_res) => {
                    if(q_err) return next(q_err);
                    res.json(q_res.rows)
    })
...
router.delete('/api/get/allpostcomments', (req, res, next) => {
...
router.post('/api/post/userprofiletodb', (req, res, next) => {
    ...
    pool.query(`INSERT INTO posts(username, email, email_verified, date_created)
                VALUES($1, $2, $4, NOW())
